<template>
  <div class="space-y-6">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
      <!-- Card 1: Jenis Produk -->
      <div
        class="kpi-card group bg-white dark:bg-gradient-to-br dark:from-slate-900 dark:to-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl p-5 transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5"
      >
        <p
        ...
        <p class="text-xl font-bold tracking-tight mt-1.5 text-slate-800 dark:text-slate-100">
          {{ stokStats.total_jenis_produk }}
        </p>
      </div>
      <!-- Card 2: Stok Aman -->
      <div
        class="kpi-card group bg-white dark:bg-gradient-to-br dark:from-slate-900 dark:to-slate-950 border border-slate-200 dark:border-retro-primary/20 rounded-xl p-5 transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5"
      >
        <p
          class="text-[11px] font-medium uppercase tracking-wider text-slate-500 dark:text-slate-400"
        >
        ...
        <p class="text-xl font-bold tracking-tight mt-1.5 text-retro-primary">
          {{ stokStats.stok_aman }}
        </p>
      </div>
      <!-- Card 3: Stok Rendah -->
      <div
        class="kpi-card group bg-white dark:bg-gradient-to-br dark:from-slate-900 dark:to-slate-950 border border-slate-200 dark:border-amber-500/20 rounded-xl p-5 transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5"
      >
        <p
          class="text-[11px] font-medium uppercase tracking-wider text-slate-500 dark:text-slate-400"
        >
        ...
        <p class="text-xl font-bold tracking-tight mt-1.5 text-amber-500 dark:text-amber-400">
          {{ stokStats.stok_rendah }}
        </p>
      </div>
      <!-- Card 4: Stok Habis -->
      <div
        class="kpi-card group bg-white dark:bg-gradient-to-br dark:from-slate-900 dark:to-slate-950 border border-slate-200 dark:border-red-500/20 rounded-xl p-5 transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5"
      >
        <p
          class="text-[11px] font-medium uppercase tracking-wider text-slate-500 dark:text-slate-400"
        >
        ...
        <p class="text-xl font-bold tracking-tight mt-1.5 text-rose-500 dark:text-rose-400">
          {{ stokStats.stok_habis }}
        </p>
      </div>
    </div>
        ...
        <table class="w-full text-left border-collapse">
          ...
          <tbody class="text-xs">
            ...
            >
              ...
              <td
                class="px-4 py-3 text-center font-bold font-mono"
                :style="{
                  color: p.stok <= 0 ? '#f87171' : p.stok <= p.stok_minimum ? '#fbbf24' : '#34d399',
                }"
              >
                {{ p.stok }}
              </td>
              ...
              <td class="px-4 py-3">
                <span
                  ...
                  :style="{
                    ...
                    color:
                      p.stok <= 0 ? '#fb7185' : p.stok <= p.stok_minimum ? '#fbbf24' : '#34d399',
                    borderColor:
                      p.stok <= 0
                        ? 'rgba(239,68,68,0.15)'
                        : p.stok <= p.stok_minimum
