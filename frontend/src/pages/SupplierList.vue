<template>
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    <!-- Form Panel -->
    <div
      class="lg:col-span-1 bg-white rounded-lg border border-slate-200 p-5 space-y-4 shadow-sm self-start"
    >
      ...
      <form @submit.prevent="handleSubmit" class="space-y-4">
        ...
        <div
          v-if="error"
          class="p-2.5 rounded-md bg-red-50 border border-red-200 text-red-600 text-xs"
        >
          {{ error }}
        </div>
    ...
    <!-- List Panel -->
    <div
      class="lg:col-span-2 bg-white rounded-lg border border-slate-200 overflow-hidden shadow-sm flex flex-col"
    >
        ...
        <table v-else class="w-full text-left text-xs border-collapse">
          ...
          <tbody class="divide-y divide-slate-100 text-slate-700">
            ...
            <tr v-for="item in list" :key="item.id" class="hover:bg-slate-50/50 transition-colors">
              ...
              <td class="py-3 px-4 text-slate-500 max-w-[250px] truncate" :title="item.alamat">
                {{ item.alamat || '-' }}
              </td>
              <td class="py-3 px-4 text-center whitespace-nowrap">
                <div class="flex items-center justify-center gap-1.5">
                  ...
                  <button
                    ...
                    class="text-xs px-2 py-1 rounded border border-slate-200 text-red-500 hover:bg-red-50"
                  >
                    Hapus
                  </button>
                </div>
    ...
    >
      <div
        class="bg-white border-2 border-red-600 rounded-lg max-w-sm w-full overflow-hidden shadow-2xl animate-slideUp font-mono"
      >
        <!-- Title bar -->
          ...
          <div class="flex items-start gap-3">
            ...
            <div>
              ...
              <p class="text-xs text-slate-500 leading-relaxed">
                ...
                <strong class="text-slate-800">{{ deleteTarget.nama }}</strong
